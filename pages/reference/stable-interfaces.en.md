...
| Security Audit Coverage (`schemas/security-audit-coverage.schema.json`)                       | Experimental | Observe-only semantic coverage contract from #2267 Phase 3. It remains separate from `ReviewCoverage`, finding lifecycle, and Gate; automatic runtime emission and Gate integration are not part of this phase                                                         |
