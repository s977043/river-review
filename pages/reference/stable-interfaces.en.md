...
| Review Coverage (`schemas/review-coverage.schema.json` / JSON and saved-run `reviewCoverage`) | Experimental | Observation contract from #2212 Phase 1. It does not affect the Gate or `decision`, and the fields added to JSON output and `.river/runs/*.json` are additive and optional. `fileScope` (added in Slice C) is optional as well                                                                                                                                                                                                                                                                                                                                                                                                                         |
